...
class MyPDO
{
    ...
    public function updateParticipe(string $id_nageur, string $id_epreuve,  array $assoc): void
    {
        if (!isset($this->pdos_select)) {
            $requete = "UPDATE participe SET  ";/* . " WHERE id_nageur = $val1 AND id_epreuve = $val2;";*/
            $cpt = 0;
            ...
            $requete .= " where  id_nageur = $id_nageur , id_epreuve = $id_epreuve ;";
        }
    ...
    {
        if (!isset($this->pdos_select)) {
            $requete = "INSERT INTO  participe(id_nageur , id_epreuve , nom_medaille , classement , date_epreuve , performance); ";/* . " WHERE id_nageur = $val1 AND id_epreuve = $val2;";*/
            $cpt = 0;
